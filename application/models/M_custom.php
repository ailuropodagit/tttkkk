...
class M_custom extends CI_Model
{
    ...
    public function get_static_option_array($option_type = NULL, $default_value = NULL, $default_text = NULL, $want_array = 0, $order_by = NULL, $show_not_hide_only = 0)
    {
        if ($order_by != NULL)
        {
...
//        }
    ...
    function getUserInfo($user_id)
    {
        ...
        $user_info = array(
            ...
            'profile_image_url' => base_url() . $this->config->item('album_user_profile') . $user['profile_image'],
            'us_ic' => $user['us_ic'],
