...
<div id="profile">
    <h1>Manage Merchant Fee Charge Type</h1>
    <div id='profile-content'>  
        <?php
        $this->load->view('admin/manage_setting_sub_menu');
        ?>
        <div style="float:right">
            <?php $add_new_url = base_url() . 'admin/manage_merchant_fee_change'; ?>           
            ...
            <table border='1px' cellspacing='0px' cellpadding='0px' id="myTable" class="display">
                ...
                <tbody>
                    ...
                    foreach ($the_result as $row)
                    {
                        ...
                        $url_edit = base_url() . "admin/manage_merchant_fee_change/" . $row['option_id'];
                        $url_special_action = base_url() . "admin/manage_merchant_fee";
                        echo '<tr>';
