...
<div id="candie-promotion">   
    ...
    if ($is_edit == 0)
    {
        echo '<h1>Merchant Fee Charge Type Add</h1>';
    }
    else
    {
        echo '<h1>Merchant Fee Charge Type Edit</h1>';
    }                       
    ?>
        ...
        <div id='profile-info'> 
            ...
            <div id='profile-info-form'>
                <div id='profile-info-form-each'>
                    <div id='profile-info-form-each-label'><?php echo 'Merchant Fee Charge Type Name :'; ?></div>
                ...
                <div id='profile-info-form-each'>
                    ...
                    <div id='profile-info-form-each-input'><?php echo form_input($option_value); ?></div>
                </div>  
            </div>
            <?php
