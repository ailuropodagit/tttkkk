<div id="layout-inner-right-menu">
    <ul>
        ...
        {            
            ...
            <li><a href='<?php echo base_url(); ?>merchant/upload_hotdeal' class='layout-inner-right-menu-bar <?php if ($this->router->fetch_method() == 'upload_hotdeal'){ echo "layout-inner-right-menu-bar-active"; } ?>'>Hot Deal Advertise</a></li>
