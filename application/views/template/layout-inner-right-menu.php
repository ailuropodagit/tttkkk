<div id="layout-inner-right-menu">
    <ul>
        ...
        else
        {
            ...
            <li><a href='<?php echo base_url(); ?>user/follower' class='layout-inner-right-menu-bar <?php if ($fetch_method == 'follower'){ echo "layout-inner-right-menu-bar-active"; } ?>'>Follower</a></li>
            <li><a href='<?php echo base_url(); ?>user/following' class='layout-inner-right-menu-bar <?php if ($fetch_method == 'following'){ echo "layout-inner-right-menu-bar-active"; } ?>'>Following</a></li>
