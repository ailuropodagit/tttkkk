...
<div id="body-right-sidebar">
    <ul>
        ...
        {            
            ...
            <li><a href='<?php echo base_url(); ?>all/album_merchant' class='body-right-sidebar-bar <?php if ($this->router->fetch_method() == 'album_merchant'){ echo "body-right-sidebar-bar-active"; } ?>'>Picture</a></li>
