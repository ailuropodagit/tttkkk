...
<div id="body-right-sidebar">
    <ul>
        ...
        else
        {
            ...
            ?>
            <li><a href='<?php echo $dashboard ?>' class='body-right-sidebar-bar <?php if ($this->router->fetch_method() == 'user_dashboard'){ echo "body-right-sidebar-bar-active"; } ?>'>Dashboard</a></li>
