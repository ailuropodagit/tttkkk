                                ...
                                if (check_correct_login_type($this->config->item('group_id_user')))
                                {
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            ...
                                            <li><a href='<?php echo base_url('user/candie_page') ?>' class='layout-inner-right-menu-bar <?php if ($fetch_method == 'candie_page'){ echo "layout-inner-right-menu-bar-active"; } ?>'>Candy (<?php echo $this->m_user->candie_check_balance($login_user_id); ?>)</a></li>
